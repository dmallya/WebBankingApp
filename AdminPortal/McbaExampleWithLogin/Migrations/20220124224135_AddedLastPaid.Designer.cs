...
{
    [DbContext(typeof(WebBankingAppContext))]
    [Migration("20220124224135_AddedLastPaid")]
    partial class AddedLastPaid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebBankingApp.Models.BillPay", b =>
                {
            ...
            modelBuilder.Entity("WebBankingApp.Models.Customer", b =>
                {
                    b.Property<int>("CustomerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebBankingApp.Models.Login", b =>
                {
            ...
            modelBuilder.Entity("WebBankingApp.Models.Payee", b =>
                {
                    b.Property<int>("PayeeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebBankingApp.Models.Account", b =>
                {
                    b.HasOne("WebBankingApp.Models.Customer", "Customer")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("WebBankingApp.Models.BillPay", b =>
                {
                    ...
                    b.HasOne("WebBankingApp.Models.Payee", "Payee")
                        .WithMany("BillPays")
            ...
            modelBuilder.Entity("WebBankingApp.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("WebBankingApp.Models.Account", "DestinationAccount")
                        .WithMany()
